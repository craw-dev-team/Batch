...
const AddCoordinatorForm = ( { isOpen, onClose, coordinatorData } ) => {
    ...
    const handleFormSubmit = async (e) => {
            ...
            try {
                ...
                response = await axiosInstance.put(`/api/coordinators/edit/${coordinatorData.id}/`, 
                    payload );
                successMessage = "Coordinator updated successfully!";
                } else {
                    // Add new course (POST)
                    response = await axiosInstance.post(`/api/coordinators/add/`, 
                        payload );
                ...
                <form className="p-4 md:p-5" onSubmit={handleFormSubmit}>
                    <div className="grid gap-4 mb-4 grid-cols-3">
                        <div className="col-span-1">
                            <label htmlFor="coordinatorId" className={`block mb-2 text-sm font-medium ${theme.text}`}>Coordinator Id</label>
                        ...
                        {/* Coordinator Name  */}
                        <div className="col-span-1">
                            <label htmlFor="coordinatorName" className={`block mb-2 text-sm font-medium ${theme.text}`}>Coordinator Name</label>
                        ...
                        {/* Coordinator Email */}
                        <div className="col-span-1">
                            <label htmlFor="coordinatorEmail" className={`block mb-2 text-sm font-medium ${theme.text}`}>Coordinator Email</label>
                         ...
                         <div className="col-span-1">
                         <label htmlFor="coordinatorNumber" className={`block mb-2 text-sm font-medium ${theme.text}`}>Phone Number</label>
                         ...
                         <label htmlFor="coordinatorWeekOff" className={`block mb-2 text-sm font-medium ${theme.text}`}>Coordinator's Week Off</label>
