...
const AddCounsellorForm = ( { isOpen, onClose, counsellorData } ) => {
    ...
    const handleFormSubmit = async (e) => {
            ...
            try {
                ...
                response = await axiosInstance.put(`/api/counsellors/edit/${counsellorData.id}/`, payload );
                successMessage = "Counsellors updated successfully!";
                } else {
                    // Add new course (POST)
                    response = await axiosInstance.post(`/api/counsellors/add/`, payload );
                ...
                <form className="p-4 md:p-5" onSubmit={handleFormSubmit}>
                    <div className="grid gap-4 mb-4 grid-cols-3">
                        <div className="col-span-1">
                            <label htmlFor="counsellorId" className={`block mb-2 text-sm font-medium ${theme.text}`}>Counsellor Id</label>
                        ...
                        {/* Coordinator Name  */}
                        <div className="col-span-1">
                            <label htmlFor="counsellorName" className={`block mb-2 text-sm font-medium ${theme.text}`}>Counsellor Name</label>
                        ...
                        {/* Coordinator Email */}
                        <div className="col-span-1">
                            <label htmlFor="counsellorEmail" className={`block mb-2 text-sm font-medium ${theme.text}`}>Counsellor Email</label>
                         ...
                         <div className="col-span-1">
                         <label htmlFor="counsellorNumber" className={`block mb-2 text-sm font-medium ${theme.text}`}>Phone Number</label>
                         ...
                         <label htmlFor="counsellorWeekOff" className={`block mb-2 text-sm font-medium ${theme.text}`}>Counsellor's Week Off</label>
