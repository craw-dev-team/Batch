                ...
                <table className="w-full text-xs text-left text-gray-500 dark:text-gray-400 ">
                    ...
                    {loading ? (
                        ...
                        <tr key={item.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 scroll-smooth">
                            ...
                            <th scope="row" className="px-3 py-2 md:px-1 font-medium text-gray-900 cursor-pointer" onClick={() => handleBookClick(item.id)}>
                                {item.book_id}
                            </th>
                            <td className="px-3 py-2 md:px-1 font-medium text-gray-900 cursor-pointer" onClick={() => handleBookClick(item.id)}>
                                {item.name}
                            </td>
