...
import { useStudentAuth } from "../Dashboard/StudentAuthContext/StudentAuthContext";
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleLogin} className="space-y-4 md:space-y-6">
                  <div>
                      ...
                      <input onChange={handleChange} type="text" name="username" id="username" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Enter Registered Email or Phone" required=""></input>
                  </div>
                  ...
                  <div>
                      <button type="submit" className="w-full bg-red-500 p-3 rounded-md hover:bg-red-600 transition-all ease-in">Login</button>
                  </div>
